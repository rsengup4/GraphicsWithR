...
data_file <- file.path(data_dir, "Assign11_12_hf_readm.csv")
comorb_file <- file.path(data_dir, "Assign11_12_comorbidities.csv")
demo_file <- file.path(data_dir, "Assign11_12_demographics.csv")
